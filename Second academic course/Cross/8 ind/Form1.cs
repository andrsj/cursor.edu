    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            switch (comboBox1.SelectedIndex)
            {
                case 0:
                    {
                        if (Convert.ToInt32(textBox1.Text) <= mbs1.MyBooksArray.Length &&
                            Convert.ToInt32(textBox1.Text) > 0)
                        {
                            label2.Text = mbs1.MyBooksArray[Convert.ToInt32(textBox1.Text) - 1].ToString();
                        }
                        else
                        {
                            label2.Text = "";
                            MessageBox.Show("Вийшли за межі об'явленого массиву об'єктів класу MyBooks1");
                            return;
                        }
                        break;
                    }
                case 1:
                    {
                        if (Convert.ToInt32(textBox1.Text) <= mbs2.MyBooksArray.Length &&
                            Convert.ToInt32(textBox1.Text) > 0)
                        {
                            label2.Text = mbs2.MyBooksArray[Convert.ToInt32(textBox1.Text) - 1].ToString();
                        }
                        else
                        {
                            label2.Text = "";
                            MessageBox.Show("Вийшли за межі об'явленого массиву об'єктів класу MyBooks2");
                            return;
                        }
                        break;
                    }
                case 2:
                    {
                        if (Convert.ToInt32(textBox1.Text) <= N && Convert.ToInt32(textBox1.Text) > 0)
                        {    
                            for (int i = 0; i < Convert.ToInt32(textBox1.Text); i++)
                            {
                                mbs3.MoveNext();
                            }
                            if (mbs3.Current == null)
                            {
                                MessageBox.Show("Додайте елементи в масив об'єктів, щоб знайти книжку!");
                                return;
                            }
                            label2.Text = mbs3.Current.ToString();
                            mbs3.Reset();
                        }
                        else
                        {
                            label2.Text = "";
                            MessageBox.Show("Вийшли за межі об'явленого массиву об'єктів класу MyBooks3");
                            return;
                        }
                        //label2.Text = mbs1.MyBooksArray[0].ToString();
                        break;
                    }
                default:
                    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            switch (comboBox1.SelectedIndex)
            {
                case 0:
                    {
                        label2.Text = mbs1.MyBooksArray[trackBar1.Value - 1].ToString();
                        break;
                    }
                case 1:
                    {
                        label2.Text = mbs2.MyBooksArray[trackBar1.Value - 1].ToString();
                        break;
                    }
                case 2:
                    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (comboBox1.SelectedIndex)
            {
                case 0:
                    {
                        trackBar1.Maximum = mbs1.MyBooksArray.Length;
                        break;
                    }
                case 1:
                    {
                        trackBar1.Maximum = mbs2.MyBooksArray.Length;
                        break;
                    }
                case 2:
                    {
